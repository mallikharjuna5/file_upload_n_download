            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
						...
						<?php
					if(count($_GET)>0){
						echo "<span style='color:orange;text-align:center;'>Mobile Number or Email Id already exsit</span>";
					}
					?>
                    ...
                    <div class="signup-image">
                        <figure><img src="images/signupp.jpg" alt="sing up image"></figure>
                        <h4><a href="index.php" class="signup-image-link">I Have Account Here</a></h4>
